...
public class ParkingDataBaseIT {
	...
	public void testParkingLotExit() {
		...
		Ticket ticket = ticketDAO.getTicket("ABCDEF");
		Assert.assertNotNull(ticket);
		double generatedPrice = ticket.getPrice();//i.e. fare generated
		Date savedInTime = ticket.getInTime();
		Date savedOutTime = ticket.getOutTime();
		FareCalculatorService fareCalculatorService = new FareCalculatorService();
		fareCalculatorService.calculateFare(ticket);
		double calculatedPrice = ticket.getPrice();//recalcul du prix d'après les autres paramètres sauvegardés du ticket
